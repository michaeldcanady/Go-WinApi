...
type FileTypeFlags int64

func (a FileTypeFlags) String() string {
...
type FileAttributeFlags int64

type ReparseTag int64

func (a ReparseTag) String() string {
	return map[int64]string{
...
const (
	VFT_UNKNOWN    FileTypeFlags = 0x00000000
	VFT_APP        FileTypeFlags = 0x00000001
	VFT_DLL        FileTypeFlags = 0x00000002
	VFT_DRV        FileTypeFlags = 0x00000003
	VFT_FONT       FileTypeFlags = 0x00000004
	VFT_STATIC_LIB FileTypeFlags = 0x00000007
	VFT_VXD        FileTypeFlags = 0x00000005
	...
	IO_REPARSE_TAG_CSV         ReparseTag = 0x80000009
	IO_REPARSE_TAG_DEDUP       ReparseTag = 0x80000013
	IO_REPARSE_TAG_DFS         ReparseTag = 0x8000000A
	IO_REPARSE_TAG_DFSR        ReparseTag = 0x80000012
	IO_REPARSE_TAG_HSM         ReparseTag = 0xC0000004
	IO_REPARSE_TAG_HSM2        ReparseTag = 0x80000006
	IO_REPARSE_TAG_MOUNT_POINT ReparseTag = 0xA0000003
	IO_REPARSE_TAG_NFS         ReparseTag = 0x80000014
	IO_REPARSE_TAG_SIS         ReparseTag = 0x80000007
	IO_REPARSE_TAG_SYMLINK     ReparseTag = 0xA000000C
	IO_REPARSE_TAG_WIM         ReparseTag = 0x80000008
)
